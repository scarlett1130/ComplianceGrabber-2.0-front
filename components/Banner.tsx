    ...
    <div className="absolute inset-0 max-h-screen bg-blue-900 ">
      ...
      <div className="absolute bottom-16 inset-x-auto w-full mt-[18rem] sm:mt-36 flex justify-center px-2 ">
        ...
        <motion.button
          ...
          className="font-poppins rounded-r-full hover:scale-105 relative mx-2  overflow-hidden text-lg group text-white rounded-md inline-flex items-center justify-center space-x-4  py-3 border-4 border-white  min-w-[350px] px-4"
          onClick={scrollDown}
        >
