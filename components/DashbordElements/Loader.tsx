...
function Loader() {
  return (
    <div className="flex w-full  justify-center h-full items-center mt-56">
      <svg
        className="animate-Loader-animation w-24 h-24 "
      ...
      <svg
        className="animate-Loader-reverse-animation w-24 h-24 "
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 100 100"
      >
        <path
